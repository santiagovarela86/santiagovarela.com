...
**Situation:**
While working for a former employer, every once in a while, a multi-disciplinary team would be created on the spot with the sole goal of solving a specific and complex problem. In this case, I was asked to be a part of that team.
...
**Action:**
I started by gathering information that would help me pinpoint the root cause. First I looked for the Windows Event Logs, and found these types of events in the Application Log:
...
Then I used the **EventCombMT** tool, that allows you to search, filter and collect events from the Event Viewer in multiple servers, to collect all these types of events from all the CCTV servers.

So, basically I got two types of events here, one indicating a crash related to the H264 codec and other related to the Microsoft Visual C++ runtime. **96% of the crashes were related to the H264 DLL**.
